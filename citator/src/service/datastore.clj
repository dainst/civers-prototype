...
(defn upsert
  "Creates or updates a resource for the given id.
   The version number must be generated by the caller
   and be completely unique (not only per id).
   
   @throws Exception if the version number already exists in the db"
  [resource id version]
  (if (exists? version)
